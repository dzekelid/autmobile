...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/autmobile/master/_listings/amadeus/apis.md
...
- name: Amadeus - Get Airports Autocomplete
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/autmobile/master/_listings/amadeus/airportsautocomplete-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/autmobile/master/_listings/amadeus/airportsautocomplete-get-openapi.md
- name: Amadeus - Get Airports Autocomplete
  x-api-slug: airportsautocomplete-get
  description: "Using the term parameter and given the start of any word in an airport's
    official name, a city name, or the start of an IATA code, this API provides the
